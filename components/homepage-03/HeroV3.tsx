...
const HeroV3 = () => {
  ...
  return (
    <section className="relative z-10 overflow-hidden pb-[830px] pt-36 md:pt-[180px] lg:pt-[240px] xl:pb-[850px]">
      ...
      <h1 className="font-instrument absolute right-4 top-56 text-5xl font-normal italic leading-[1.1] sm:text-7xl md:top-60 md:text-8xl lg:right-36 lg:top-72 lg:text-9xl xl:right-60 xl:top-96 xl:text-[156px]">
        Agency
      </h1>
