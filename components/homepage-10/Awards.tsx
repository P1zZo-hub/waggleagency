      ...
      <RevealWrapper className="divide-y-[1px] dark:divide-dark dark:last:border-dark max-md:last:border-b sm:px-10 [&>*:first-child]:border-t dark:[&>*:first-child]:border-dark">
        {achievements.map((achievement, index) => (
          <div
            ...
            <span className="font-instrument relative z-20 col-span-2 justify-self-center text-sm font-normal italic leading-[1.4] transition-colors duration-300 group-hover:text-white max-md:col-span-2 md:text-[19px]">
              {achievement.year}
            </span>
