...
const AwardItem = ({ year, title, organization, achievement }: AwardsProps) => {
  return (
    <div className="group relative grid h-full grid-cols-12 items-center overflow-hidden px-5 py-10 text-left max-md:text-center">
      ...
      <span className="font-instrument relative z-20 col-span-2 justify-self-center text-[19px] font-normal italic leading-[1.4] transition-colors duration-300 group-hover:text-white max-md:col-span-6">
        {year}
      </span>
