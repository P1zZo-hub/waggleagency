...
// Data-----------------
const topContent = ['Strategy', 'Branding', 'Social Management', 'Shooting', 'Web Growth', 'Advertising', 'Marketing']
const bottomContent = ['Since NOW', 'Based in Trapani', 'Waggle Style']
